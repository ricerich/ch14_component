...
//    MyBroadcastReceiver br = new MyBroadcastReceiver(ivBattery, edtBattery);
//    MyBroadcastReceiver br = new MyBroadcastReceiver(MainActivity.this);
            ...
            if (action.equals(Intent.ACTION_BATTERY_CHANGED)) {
                ...
                switch (plug) {
                    ...
                    case BatteryManager.BATTERY_PLUGGED_AC:
                        edtBattery.append("전원 연결 : AC어댑터 연결됨");
                        break;
